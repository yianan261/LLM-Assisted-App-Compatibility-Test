...
class GeminiAPI:
    ...
    def process_image(self, image_file, prompt):
        ...
        screenshot_picture = {"mime_type": "image/png", "data": image_file.read()}
        ...
        try:
            ...
            if output_text_match and flag_match:
                ...
                return {"output_text": output_text, "flag": flag}
            else:
                print(
                    "Error: Unable to extract output_text and flag from the response."
                )
